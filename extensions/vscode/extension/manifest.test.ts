...
it('manifest registers WeChat JSON Schema validation', () => {
  assert.deepEqual(packageJson.contributes.jsonValidation, [
    { fileMatch: ['**/app.json', '**/app.jsonc', '**/app.json.ts', '**/app.json.js'], url: 'https://vite.weapp.dev/app.json' },
    { fileMatch: ['**/page.json', '**/page.jsonc', '**/page.json.ts', '**/page.json.js'], url: 'https://vite.weapp.dev/page.json' },
    { fileMatch: ['**/component.json', '**/component.jsonc', '**/component.json.ts', '**/component.json.js'], url: 'https://vite.weapp.dev/component.json' },
    { fileMatch: ['**/sitemap.json', '**/sitemap.jsonc', '**/sitemap.json.ts', '**/sitemap.json.js'], url: 'https://vite.weapp.dev/sitemap.json' },
    { fileMatch: ['**/theme.json', '**/theme.jsonc', '**/theme.json.ts', '**/theme.json.js'], url: 'https://vite.weapp.dev/theme.json' },
    { fileMatch: ['**/plugin.json', '**/plugin.jsonc', '**/plugin.json.ts', '**/plugin.json.js'], url: 'https://vite.weapp.dev/plugin.json' },
  ])
})
...
it('manifest avoids broad Vite and package.json workspace activation', () => {
  assert.equal(packageJson.activationEvents.includes('workspaceContains:**/vite.config.ts'), false)
  assert.equal(packageJson.activationEvents.includes('workspaceContains:**/vite.config.mts'), false)
  assert.equal(packageJson.activationEvents.includes('workspaceContains:**/vite.config.cts'), false)
  assert.equal(packageJson.activationEvents.includes('workspaceContains:**/vite.config.js'), false)
  assert.equal(packageJson.activationEvents.includes('workspaceContains:**/vite.config.mjs'), false)
  assert.equal(packageJson.activationEvents.includes('workspaceContains:**/vite.config.cjs'), false)
  ...
  assert.equal(packageJson.activationEvents.includes('workspaceContains:**/node_modules/weapp-vite/package.json'), true)
  assert.equal(packageJson.activationEvents.includes('workspaceContains:**/package.json'), false)
})
...
it('manifest exposes local verification scripts', () => {
  ...
  assert.equal(packageJson.scripts['release:marketplace'], 'node --import tsx scripts/plan-marketplace-release.ts')
