...
const communitySidebarItems: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'uview-plus 与 uni-app', link: '/integration/uview-plus' },
...
const _handbookSidebarItems: DefaultTheme.SidebarItem[] = [
  {
    ...
    collapsed: false,
    items: [
      { text: '创建项目，跑起来', link: '/handbook/' },
      { text: '目录怎么放', link: '/handbook/project-structure' },
      { text: '环境变量和配置', link: '/handbook/env-and-config' },
      { text: '构建产物长什么样', link: '/handbook/build-and-output' },
    ],
  },
  {
    text: '写页面',
    collapsed: false,
    items: [
      { text: '.vue 怎么变成小程序', link: '/handbook/sfc/' },
      { text: '模板和事件怎么写', link: '/handbook/sfc/template' },
      { text: '脚本逻辑怎么组织', link: '/handbook/sfc/script-setup' },
      { text: '样式和资源怎么处理', link: '/handbook/sfc/style' },
      { text: '组件怎么拆', link: '/handbook/sfc/components' },
      { text: '常用写法速查', link: '/handbook/sfc/cookbook' },
    ],
  },
  {
    text: '理解运行时',
    collapsed: false,
    items: [
      { text: 'Wevu 是什么，不是什么', link: '/handbook/wevu/' },
  ...
  },
  {
    ...
    collapsed: false,
    items: [
      { text: '页面跳转', link: '/handbook/navigation' },
      { text: '网络请求', link: '/handbook/network' },
      { text: '调用原生能力', link: '/handbook/native-apis' },
      { text: '分包', link: '/handbook/subpackages' },
    ],
  },
  {
    text: '上线和维护',
    collapsed: false,
    items: [
      { text: '性能优化', link: '/handbook/performance' },
      { text: '调试排错', link: '/handbook/debugging' },
      { text: '构建和发布', link: '/handbook/publish' },
      { text: '从旧项目迁移', link: '/handbook/migration' },
      { text: '速查索引', link: '/handbook/reference' },
    ],
  },
]
