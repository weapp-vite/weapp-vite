...
const packagesSidebarItems: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    collapsed: false,
    items: [
      { text: '@wevu/compiler（编译底座）', link: '/packages-runtime/wevu-compiler' },
      {
        text: '@wevu/api（跨端 API）',
        collapsed: false,
        items: [
          { text: '总览', link: '/packages-runtime/weapi/' },
          { text: '兼容总览', link: '/packages-runtime/weapi/compat-overview' },
          { text: 'API 全量清单', link: '/packages-runtime/weapi/wx-method-list' },
          {
            text: '支付宝兼容矩阵',
            link: '/packages-runtime/weapi/alipay-compat-matrix',
          },
          {
            text: '抖音兼容矩阵',
            link: '/packages-runtime/weapi/douyin-compat-matrix',
          },
          { text: '兼容差异说明', link: '/packages-runtime/weapi/gap-notes' },
          {
            text: '平台独有 API 清单',
            link: '/packages-runtime/weapi/platform-only-methods',
          },
        ],
      },
      { text: '@weapp-vite/web（Web 实验运行时）', link: '/packages-runtime/web' },
...
const weapiSidebarItems: DefaultTheme.SidebarItem[] = [
  {
    ...
    collapsed: false,
    items: [
      { text: 'Docs 首页', link: '/packages-runtime/weapi/' },
      { text: 'wpi 概览', link: '/packages-runtime/weapi/overview' },
      { text: '兼容总览', link: '/packages-runtime/weapi/compat-overview' },
      {
        text: 'API 全量清单',
        link: '/packages-runtime/weapi/wx-method-list',
        collapsed: false,
        items: WEAPI_CAPABILITY_GROUPS.map(group => ({
          text: group.label,
          link: `/packages-runtime/weapi/wx-method-list/${group.key}`,
        })),
      },
      {
        text: '支付宝兼容矩阵',
        ...
        items: WEAPI_CAPABILITY_GROUPS.map(group => ({
          text: group.label,
          link: `/packages-runtime/weapi/alipay-compat-matrix/${group.key}`,
        })),
      },
      {
        text: '抖音兼容矩阵',
        ...
        items: WEAPI_CAPABILITY_GROUPS.map(group => ({
          text: group.label,
          link: `/packages-runtime/weapi/douyin-compat-matrix/${group.key}`,
        })),
      },
      { text: '兼容差异说明', link: '/packages-runtime/weapi/gap-notes' },
      {
  ...
  defineConfig({
    ...
    themeConfig: {
      ...
      nav: [
        ...
        { text: 'Wpi', link: '/packages-runtime/weapi/' },
      ...
      sidebar: {
        ...
        '/packages-runtime/weapi/': weapiSidebarItems,
