...
export const wevuTypeSeeds: WevuApiSeed[] = [
  ...
  typeSeed('AsyncDerivationStatus', 'asyncderivationstatus', '异步派生的公开状态联合类型。', 'wevu-extension'),
  typeSeed('AsyncDerivationContext', 'asyncderivationcontext', '异步加载函数接收的取消上下文。', 'wevu-extension'),
  typeSeed('UseAsyncDerivationOptions', 'useasyncderivationoptions', '异步派生的立即加载配置。', 'wevu-extension'),
  typeSeed('AsyncDerivationState<T>', 'asyncderivationstate', '异步派生的可辨识只读状态。', 'wevu-extension'),
  typeSeed('AsyncDerivation<T>', 'asyncderivation', '异步派生状态与控制方法的组合类型。', 'wevu-extension'),
