  ...
  <view class="container">
    ...
    <view class="section">
      ...
      <view class="demo-item">
        ...
        <button class="btn btn-primary" @tap="rotatePhase">切换</button>
      </view>
      <view class="card">
    ...
    <view class="section">
      ...
      <view class="demo-item">
        ...
        <button class="btn btn-success" @tap="toggleVisible">切换</button>
      </view>
    ...
    <view class="section">
      ...
      <view class="demo-item">
        ...
        <button class="btn btn-info" @tap="refreshTime">刷新</button>
      </view>
      <view class="card">
