...
export default {
  setup() {
    ...
    function goDetail() {
      wx.navigateTo({ url: '/subpackages/normal-b/pages/detail/index?from=home' })
    }

    function goNormalA() {
      wx.navigateTo({ url: '/subpackages/normal-a/pages/home/index?from=normal-b' })
    }

    function goIndependentB() {
      wx.navigateTo({ url: '/subpackages/independent-b/pages/home/index?from=normal-b' })
    }
