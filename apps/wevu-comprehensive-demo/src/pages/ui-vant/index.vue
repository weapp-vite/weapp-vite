...
import { toVantComponentName, vantComponentTags } from './components-list'
...
definePageJson(() => ({
  navigationBarTitleText: 'Vant 组件',
}))
...
const items = computed(() => {
  ...
  return vantComponentTags
    .map((tag) => {
      const name = toVantComponentName(tag)
      return {
        tag,
        name,
        pagePath: `/pages/ui-vant/components/${name}/index`,
      }
    })
        ...
        <view class="list">
          ...
          >
            ...
            <view class="list-subtitle">
              pages/ui-vant/components/{{ item.name }}/index
            </view>
          </view>
        </view>
      </view>
