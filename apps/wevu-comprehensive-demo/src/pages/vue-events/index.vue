  ...
  <view class="container">
    ...
    <view class="section">
      ...
      <view class="demo-item">
        ...
        <button class="btn btn-primary" @click="handleTap">click → tap</button>
      </view>
    ...
    <view class="section">
      ...
      <view class="card">
        ...
        <button class="btn btn-primary" @click.stop.prevent="append('stop+prevent')">.stop.prevent</button>
        <button class="btn btn-success" @click.once="handleOnce">.once</button>
    ...
    <view class="section">
      ...
      <view class="demo-item">
        ...
        <button class="btn btn-warning" @click="clear">清空</button>
      </view>
      <view class="card">
