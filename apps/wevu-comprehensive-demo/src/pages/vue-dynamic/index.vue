...
<template>
  <view class="container">
    ...
    <view class="section">
      ...
      <view class="card">
        <view class="actions">
          <button size="mini" class="btn btn-primary" @click="togglePanel">
            切换组件
          </button>
          <button size="mini" class="btn btn-success" @click="toggleKeepAlive">
            keepAlive: {{ keepAlive }}
          </button>
          <button size="mini" class="btn btn-info" @click="toggleTip">
            切换 tip
          </button>
        </view>
    ...
    <view class="section">
      ...
      <view class="card">
        <view class="actions">
          <button size="mini" class="btn btn-warning" @click="shuffleGroup">
            reverse
          </button>
        </view>
