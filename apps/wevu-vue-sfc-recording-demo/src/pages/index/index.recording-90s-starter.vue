...
definePageJson({
  navigationBarTitleText: '录屏 90s 起始态',
})
...
const features = ref<DemoFeature[]>([
  { name: 'Vue SFC 编译', done: true },
  { name: 'definePageJson 宏', done: true },
...
<template>
  <view class="page">
    ...
    <text class="subtitle">目标：90 秒内演示补全、保存、热更新。</text>
    ...
    <view class="card">
      ...
      <view class="row between">
        ...
        <text class="value">{{ features.length }}</text>
      </view>
