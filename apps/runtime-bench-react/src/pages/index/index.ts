...
import { ReactIndexPage } from './view'
...
Page({
  ...
  onLoad() {
    ...
    root.render(createElement(ReactIndexPage, { ref: controller, setDataCounter }))
  },
  onReady() {
  ...
  async navigateToDetail() {
    await new Promise<void>((resolve, reject) => {
      wx.navigateTo({ url: '/pages/detail/index', success: () => resolve(), fail: reject })
    })
    return true
  },
})
