  ...
  render() {
    return (
      <view class="page">
        ...
        <view id="vue-tsx-state" class={this.enabled ? 'card card-on' : 'card card-off'}>
          {this.enabled
            ? <text>当前状态：已启用 ✅</text>
            : <text>当前状态：未启用 ⛔️</text>}
        </view>
        <button id="vue-tsx-toggle" class="btn" onTap={this.toggleEnabled}>切换状态</button>
