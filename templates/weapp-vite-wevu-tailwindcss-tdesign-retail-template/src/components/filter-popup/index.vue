  ...
  >
    <view class="content [&_.filter-btns-wrap]:[width:100%] [&_.filter-btns-wrap]:[position:absolute] [&_.filter-btns-wrap]:[bottom:calc(20rpx_+_env(safe-area-inset-bottom))] [&_.filter-btns-wrap]:[display:flex] [&_.filter-btns-wrap]:[flex-direction:row] [&_.filter-btns-wrap]:[border-radius:10rpx_0_0_10rpx] [&_.filter-btns-wrap]:[padding:16rpx_32rpx] [&_.filter-btns-wrap]:[border-top:1rpx_solid_#e5e5e5] [&_.filter-btns-wrap]:[box-sizing:border-box]">
      ...
      <view class="filter-btns-wrap">
        <view class="filter-btn btn-reset [flex:1] [display:flex] [justify-content:center] [align-items:center] [font-size:28rpx] [font-weight:500] [height:80rpx] [color:#fa4126] [background:rgba(255,_255,_255,_1)] [position:relative] [border:1rpx_solid_#fa4126] [border-radius:84rpx_0_0_84rpx]" @tap="reset">
          重置
        </view>
        <view class="filter-btn btn-confirm [flex:1] [display:flex] [justify-content:center] [align-items:center] [font-size:28rpx] [font-weight:500] [height:80rpx] [border-radius:0_84rpx_84rpx_0] [border:1rpx_solid_#fa4126] [color:#fff] [background:#fa4126]" data-index="5" @tap="confirm">
          确定
        </view>
      </view>
    </view>
