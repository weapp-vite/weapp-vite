  ...
  <view :class="afterServicePageClass">
    <t-pull-down-refresh id="t-pull-down-refresh" t-class-indicator="t-class-indicator" @refresh="onPullDownRefresh_">
      ...
      <view :class="serviceDetailClass">
        ...
        <!-- 退款金额 -->
        <view v-if="service.isRefunded" :class="serviceRefundSectionClass">
          <t-cell
            t-class-title="title"
            t-class-note="right"
        ...
        <!-- 退款信息 -->
        <view :class="serviceInfoSectionClass">
        ...
        <!-- 凭证/说明 -->
        <view v-if="showProofs" :class="serviceCredentialSectionClass">
          <t-cell
            :bordered="false"
            title="凭证/说明"
            t-class="t-refund-wrapper ![padding-top:18rpx] ![padding-bottom:18rpx]"
