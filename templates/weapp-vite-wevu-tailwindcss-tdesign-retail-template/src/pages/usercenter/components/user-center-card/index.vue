...
<template>
  <view class="user-center-card fixed top-0 left-0 w-full h-[480rpx] bg-[url(https://tdesign.gtimg.com/miniprogram/template/retail/template/user-center-bg-v1.png)] bg-cover bg-no-repeat p-[0_24rpx] [background-image:url('https://tdesign.gtimg.com/miniprogram/template/retail/template/user-center-bg-v1.png')]">
    <!-- 未登录的情况 -->
