...
<template>
  <view class="user-center-card [position:fixed] [top:0] [left:0] [width:100%] [height:480rpx] [background-image:url(https://tdesign.gtimg.com/miniprogram/template/retail/template/user-center-bg-v1.png)] [background-size:cover] [background-repeat:no-repeat] [padding:0_24rpx] [background-image:url('https://tdesign.gtimg.com/miniprogram/template/retail/template/user-center-bg-v1.png')]">
    ...
    <block v-if="currAuthStep === AuthStepType.ONE">
      <view class="user-center-card__header [margin-top:192rpx] [margin-bottom:48rpx] [height:96rpx] [line-height:48rpx] [display:flex] [justify-content:flex-start] [align-items:center] [color:#333] [position:relative]" @tap="gotoUserEditPage">
        ...
        <view class="user-center-card__header__name [font-size:36rpx] [line-height:48rpx] [color:#333] [font-weight:bold] [margin-left:24rpx] [margin-right:16rpx]">
          {{ '请登录' }}
        </view>
      </view>
    </block>
    ...
    <block v-if="currAuthStep === AuthStepType.TWO">
      <view class="user-center-card__header [margin-top:192rpx] [margin-bottom:48rpx] [height:96rpx] [line-height:48rpx] [display:flex] [justify-content:flex-start] [align-items:center] [color:#333] [position:relative]">
        ...
        <!-- 需要授权用户信息，通过slot添加弹窗 -->
        <view v-if="isNeedGetUserInfo" class="user-center-card__header__transparent [position:absolute] [left:0] [top:0] [background-color:transparent] [height:100%] [width:100%]">
          <slot name="getUserInfo" />
        </view>
        <!-- 不需要授权用户信息，仍然触发gotoUserEditPage事件 -->
        <view v-else class="user-center-card__header__transparent [position:absolute] [left:0] [top:0] [background-color:transparent] [height:100%] [width:100%]" @tap="gotoUserEditPage" />
      </view>
    </block>
    <!-- 已登录且已经授权用户信息的情况 -->
