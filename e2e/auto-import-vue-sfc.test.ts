...
describe.sequential('auto import local components (e2e)', () => {
  it('covers local/resolver auto-import and emits dts for editor intellisense', async () => {
    ...
    expect(vueDts).toContain('typeof import("./src/components/AutoCard/index.vue")')
    expect(vueDts).toContain('typeof import("./src/components/NativeCard/index")')
    expect(vueDts).toContain('AutoCard:')
    expect(vueDts).toContain('NativeCard:')
    expect(vueDts).toContain('ResolverCard:')
    expect(vueDts).toContain('ComponentProp<"AutoCard">')
