...
describe.sequential('e2e app: github-issues (build)', () => {
  ...
  it('issue #300: keeps boolean props available in runtime call-expression bindings', async () => {
    ...
    expect(probeJs).toContain('Object.prototype.hasOwnProperty.call(this.__wevuProps, "bool")')
    expect(probeJs).toContain(': this.bool')
    ...
    expect(strictProbeJs).toContain('Object.prototype.hasOwnProperty.call(this.__wevuProps, "bool")')
    expect(strictProbeJs).toContain(': this.bool')
