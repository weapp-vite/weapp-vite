...
describe('web runtime production build (weapp-vite-web-demo)', { concurrent: false }, () => {
...
describeWeb('web runtime browser baseline (weapp-vite-web-demo)', { concurrent: false }, () => {
