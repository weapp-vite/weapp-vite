...
import sources from 'virtual:stateful-native-component-fixture'
import { expect, it } from 'vitest'
import { createBrowserHeadlessSession, createBrowserVirtualFiles } from '../src/browser'

it('keeps parent and child DOM state through the real bridge patch and restoration', () => {
  ...
  try {
    ...
    const check = (parent: string, counter: string, result: string, input = 'held-input') => {
      render()
