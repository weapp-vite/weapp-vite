...
- 已支持部分常用宿主 API，如导航、request mock、sync/async storage 与 storage info、toast、loading、system info、window/app base info、menu button rect、`wx.canIUse`、`wx.nextTick`
