...
import { CUSTOM_TAB_BAR_ALIAS, CUSTOM_TAB_BAR_COMPONENT_PATH, getCustomTabBarScopeId } from '../customTabBar'
import {
...
function renderCustomTabBar(
  ...
  const renderedRoot = renderRuntimeComponentTemplate(
    context,
    componentEntry,
    renderNodeTree,
    componentScope,
