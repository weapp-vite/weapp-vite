...
Page({
  ...
  runCanvasTransformLab() {
    ...
    ctx.beginPath()
    ctx.moveTo(0, 0)
    ctx.quadraticCurveTo(10, 2, 14, 12)
    ctx.bezierCurveTo(16, 6, 18, 10, 22, 4)
    ctx.arcTo(22, 4, 28, 16, 3)
    ctx.rect(2, 3, 16, 10)
...
`],
    ...
    expect(page.data.snapshot).toContain('"type":"arcTo"')
    expect(page.data.snapshot).toContain('"type":"bezierCurveTo"')
    expect(page.data.snapshot).toContain('"type":"clip"')
    expect(page.data.snapshot).toContain('"args":["evenodd"]')
    expect(page.data.snapshot).toContain('"type":"quadraticCurveTo"')
    ...
    expect(page.data.snapshot).toContain('"type":"setGlobalAlpha"')
    expect(page.data.snapshot).toContain('"type":"setLineDash"')
    expect(page.data.snapshot).toContain('"type":"setLineJoin"')
    expect(page.data.snapshot).toContain('"type":"setMiterLimit"')
    expect(page.data.snapshot).toContain('"type":"fill"')
