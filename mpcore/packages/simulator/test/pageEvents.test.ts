...
describe('page event alignment', () => {
  ...
  it('supports createCanvasContext in headless runtime', () => {
    ...
    expect(page.data.tempFileInfo).toContain('"errMsg":"getFileInfo:ok"')
    expect(page.data.tempFileInfo).toContain('"size":23')
    expect(page.data.tempFileInfo).toContain('"digest":"9ff15fd9f0a597794a846fcacdb42538"')
    expect(page.data.savedFileDigestInfo).toContain('"errMsg":"getFileInfo:ok"')
