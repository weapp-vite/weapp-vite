export const importedTemplateFiles: Array<[string, string]> = [
  ...
  ['templates/card.wxml', '<import src="./private" /><template name="card"><view id="card"><template is="private" data="{{label:label}}" /></view></template>'],
  ...
  ['components/card.wxml', '<import src="/templates/private" /><template is="private" data="{{label:label}}" />'],
]
