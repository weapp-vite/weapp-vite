...
definePageJson({ navigationBarTitleText: 'wd-sticky-box' })
...
<template>
  <view id="e2e-root" class="scenario-page" data-component="wd-sticky-box">
    <view class="scenario-header">
      <view class="scenario-title">wd-sticky-box</view>
      <view class="scenario-status">rendered / interactive</view>
    </view>
    <view id="e2e-target" class="scenario-subject">
      <wd-sticky-box id="e2e-component" ref="e2eComponent"><wd-sticky :offset-top="0"><view class="sticky-content">Sticky box content</view></wd-sticky></wd-sticky-box>
    </view>
