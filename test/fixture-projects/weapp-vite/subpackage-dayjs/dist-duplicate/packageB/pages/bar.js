...
var baseline = (0, (/* @__PURE__ */ require_rolldown_runtime.__toESM(require_weapp_shared_virtual_packageA_packageB_common.require_dayjs_min(), 1)).default)("2000-01-01T00:00:00");
Page({
	data: {
		shared: require_weapp_shared_virtual_packageA_packageB_common.buildSharedMessage("packageB"),
