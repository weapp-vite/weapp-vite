...
function renderCatalog(catalog, platform) {
  ...
  const baseLines = [
    ...
    '  hidden?: boolean',
    '  key?: string | number',
    `  onTap?: ${platform.typePrefix}IntrinsicEventHandler`,
    `  catchTap?: ${platform.typePrefix}IntrinsicEventHandler`,
    `  captureBindTap?: ${platform.typePrefix}IntrinsicEventHandler`,
    `  captureCatchTap?: ${platform.typePrefix}IntrinsicEventHandler`,
    `  onTouchStart?: ${platform.typePrefix}IntrinsicEventHandler`,
    `  onTouchMove?: ${platform.typePrefix}IntrinsicEventHandler`,
    `  onTouchEnd?: ${platform.typePrefix}IntrinsicEventHandler`,
