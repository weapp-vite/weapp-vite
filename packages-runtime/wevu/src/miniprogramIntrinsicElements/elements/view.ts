 ...
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/view-container/view
 */
export type MiniProgramIntrinsicElementView = MiniProgramIntrinsicElementBaseAttributes & {
  'hover-class'?: string
