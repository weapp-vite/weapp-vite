 ...
 * @see https://opendocs.alipay.com/mini/component/label
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/list/label
 */
export type MiniProgramIntrinsicElementLabel = MiniProgramIntrinsicElementBaseAttributes & {
  for?: string
}
