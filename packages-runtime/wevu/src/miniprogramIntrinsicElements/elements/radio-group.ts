 ...
 * @see https://opendocs.alipay.com/mini/component/radio-group
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/list/radio-group
 */
export type MiniProgramIntrinsicElementRadioGroup = MiniProgramIntrinsicElementBaseAttributes
