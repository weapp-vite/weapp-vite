 ...
 */
export type MiniProgramIntrinsicElementShareElement = MiniProgramIntrinsicElementBaseAttributes & {
  duration?: number
...
export type WeappIntrinsicElementShareElement = MiniProgramIntrinsicElementShareElement
