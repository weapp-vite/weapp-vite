 ...
 */
export type MiniProgramIntrinsicElementCoverImage = MiniProgramIntrinsicElementBaseAttributes & {
  'scroll-top'?: number | string
}

export type WeappIntrinsicElementCoverImage = MiniProgramIntrinsicElementCoverImage
