 ...
 */
export type MiniProgramIntrinsicElementRadio = MiniProgramIntrinsicElementBaseAttributes & {
  checked?: boolean
  color?: string
  disabled?: boolean
  value?: string
...
export type WeappIntrinsicElementRadio = MiniProgramIntrinsicElementRadio
