...
/**
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/list/switch
 */
export type TtIntrinsicElementSwitch = TtIntrinsicElementBaseAttributes & {
  checked?: boolean
  disabled?: boolean
