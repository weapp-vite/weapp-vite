...
- 📦 **Dependencies** [`8d7c0a2`](https://github.com/weapp-vite/weapp-vite/commit/8d7c0a292cd98462ba127f7ab4fd5077a09b54de)
  → `rolldown-require@2.0.24`, `@weapp-vite/ast@6.19.3`
...
- 📦 **Dependencies** [`511dd9f`](https://github.com/weapp-vite/weapp-vite/commit/511dd9f9eae061d68342c21175d792b9cc44c0b5)
  → `@weapp-core/constants@0.1.13`, `@weapp-vite/ast@6.18.2`
...
- 📦 **Dependencies** [`75e79fb`](https://github.com/weapp-vite/weapp-vite/commit/75e79fb08afc3165ff66fefeffe42623ffb48d62)
  → `@weapp-core/shared@3.0.5`, `@weapp-vite/ast@6.17.2`
...
- 🐛 **增强 `<script setup>` 中 `defineProps` 声明 `id/class/slot` 时的编译期提示，warning 现在会带上 SFC 文件路径与行列号，方便从终端或 IDE 日志一键定位到需要修改的位置。** [#646](https://github.com/weapp-vite/weapp-vite/pull/646) by @sonofmagic
...
- 📦 **Dependencies** [`6e5604f`](https://github.com/weapp-vite/weapp-vite/commit/6e5604fd86e11a6921b5eca4722d145dab1c8a1d)
  → `@weapp-core/constants@0.1.12`, `@weapp-vite/ast@6.16.29`
...
- 🐛 **修复 Vue SFC 内联事件表达式中函数调用目标被误补 `.value` 的问题，保留 `handle(count)` 这类调用里的函数目标，同时继续对 ref 参数读取和赋值目标写回 `.value`。** [`163b3ef`](https://github.com/weapp-vite/weapp-vite/commit/163b3ef6a7e423f1c04a5ac4274d0a075e890778) by @sonofmagic
- 📦 **Dependencies**
...
- 📦 **Dependencies** [`362bbd3`](https://github.com/weapp-vite/weapp-vite/commit/362bbd3e3bbed438746fe4db00602204da8c7ec2)
  → `@weapp-core/constants@0.1.8`, `@weapp-vite/ast@6.16.17`
...
- 📦 **Dependencies** [`74978d8`](https://github.com/weapp-vite/weapp-vite/commit/74978d89dfc25439803b7003119ee57b8fadc27f)
  → `rolldown-require@2.0.16`, `@weapp-vite/ast@6.16.15`
...
- 🐛 **修复 auto 模式下第三方小程序原生组件默认插槽被误判为增强作用域插槽的问题，避免 TDesign/Vant 等 kebab-case 原生组件在普通插槽内容中生成 `generic:scoped-slots-*`。** [`3d4f20d`](https://github.com/weapp-vite/weapp-vite/commit/3d4f20d220d8b065179828d9a1333d83d0adf099) by @sonofmagic
- 📦 **Dependencies**
...
- 🐛 **修复增强 scoped slot 递归编译时，原生小程序组件的普通默认插槽被继续拆成嵌套 scoped slot 组件的问题，避免生成多余的 `index.__scoped-slot-default-*` 产物。** [`e3e6862`](https://github.com/weapp-vite/weapp-vite/commit/e3e68623f990c18bd9f0f98dc53b7742f38b19b4) by @sonofmagic
- 📦 **Dependencies**
...
- 🐛 **修复 `src/app.vue` 应用外壳模板中的普通默认 `<slot />` 被编译为增强 scoped slot generic 的问题，避免微信开发者工具真实运行时加载模板外壳时出现 `WAServiceMainContext.js` timeout。** [`d4d0332`](https://github.com/weapp-vite/weapp-vite/commit/d4d0332866bd281ee3b491fd5843de07f26e1bd5) by @sonofmagic
...
- 🐛 **修复组件节点直接使用 `v-for` 时，隐式默认插槽的 `vue-slots` 元数据没有注入的问题。** [#568](https://github.com/weapp-vite/weapp-vite/pull/568) by @sonofmagic
...
- 📦 **Dependencies** [`9819abe`](https://github.com/weapp-vite/weapp-vite/commit/9819abe0df6e7871f868345192e76b770c0dd394)
  → `@weapp-core/constants@0.1.6`, `@weapp-vite/ast@6.16.9`
...
- 🐛 **修复组件节点直接使用 `v-for` 时，隐式默认插槽的 `vue-slots` 元数据没有注入的问题。** [#556](https://github.com/weapp-vite/weapp-vite/pull/556) by @sonofmagic
...
- 📦 **Dependencies** [`a24f77a`](https://github.com/weapp-vite/weapp-vite/commit/a24f77a442675d757358443eeadb1af7e06a810d)
  → `@weapp-core/constants@0.1.5`, `@weapp-vite/ast@6.16.8`
...
- 📦 **Dependencies** [`43bcefc`](https://github.com/weapp-vite/weapp-vite/commit/43bcefc22656df15897ff5cb960cdbe3f106d04b)
...
- 📦 **Dependencies** [`4884ea5`](https://github.com/weapp-vite/weapp-vite/commit/4884ea5c2cb13e267ed245f8b42ed74b8ea09fa4)
  → `@weapp-core/constants@0.1.3`, `@weapp-vite/ast@6.15.17`
...
- 📦 **Dependencies** [`624f9ee`](https://github.com/weapp-vite/weapp-vite/commit/624f9ee0bf09d9cf5a5d0815cbff1aa094cdd702)
  → `rolldown-require@2.0.14`, `@weapp-vite/ast@6.15.9`
...
- 🐛 **为 `@wevu/compiler` 增加中性的默认模板平台导出 `defaultMiniProgramTemplatePlatform`，方便外部工具和多平台接入代码复用默认模板适配器时，不再继续依赖 `wechatPlatform` 这类偏微信语义的命名。** [`d591325`](https://github.com/weapp-vite/weapp-vite/commit/d591325ed930419851dd0e5343e64b583284539c) by @sonofmagic
...
- 📦 **Dependencies** [`1f76780`](https://github.com/weapp-vite/weapp-vite/commit/1f76780d69a3e0a7f8d9d197f50865c7d6d0c3b3)
  → `@weapp-core/shared@3.0.4`, `@weapp-vite/ast@6.15.7`
...
- 📦 **Dependencies** [`a1951ca`](https://github.com/weapp-vite/weapp-vite/commit/a1951ca0c73cca640f4897ed42814f787b5e6446)
  → `@weapp-core/constants@0.1.1`, `@weapp-vite/ast@6.15.4`
...
- 📦 **Dependencies** [`db65791`](https://github.com/weapp-vite/weapp-vite/commit/db65791b4d042b3090d3f4eecae30d2cc6ca7da5)
  → `@weapp-core/constants@0.1.0`, `@weapp-vite/ast@6.15.1`
...
- 🐛 **修复内联事件编译产物与运行时 dataset 读取约定不一致的问题：Vue 模板与 JSX 事件现在都会按事件名输出 `data-wv-inline-id-*`，避免 `@click` / `bindtap` 等内联处理函数在运行时无法命中，并补齐对应的编译与运行时回归测试。** [#439](https://github.com/weapp-vite/weapp-vite/pull/439) by @sonofmagic
- 📦 **Dependencies** [`0cc4a6e`](https://github.com/weapp-vite/weapp-vite/commit/0cc4a6e8a604f160a14ce1a7868b079cad166522)
  → `rolldown-require@2.0.13`, `@weapp-vite/ast@6.15.0`
...
- 📦 **Dependencies** [`8bb15f2`](https://github.com/weapp-vite/weapp-vite/commit/8bb15f2f5db775bb2cec4b1d90e6c6ac746e50aa)
...
- 📦 **Dependencies** [`09b2383`](https://github.com/weapp-vite/weapp-vite/commit/09b2383906143adebb7717d59fe274d34a7b9a97)
  → `@weapp-core/shared@3.0.3`, `@weapp-vite/ast@6.13.4`
