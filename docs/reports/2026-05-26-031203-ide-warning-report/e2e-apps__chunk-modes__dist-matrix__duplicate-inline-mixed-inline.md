# IDE Warning/Error 项目报告：e2e-apps/chunk-modes/dist-matrix/duplicate-inline-mixed-inline
...
1. `1` 次：`[runtime/launch-bridge/info] connected=ws://127.0.0.1:62412`
   - 示例原始行：`[info] [runtime:launch-bridge] connected=ws://127.0.0.1:62412`
