# IDE Warning/Error 项目报告：e2e-apps/base
...
1. `ide:index:base` -> warn=0 error=0 exit=0
...
1. `1` 次：`[runtime/launch-bridge/info] connected=ws://127.0.0.1:51623`
   - 示例原始行：`[info] [runtime:launch-bridge] connected=ws://127.0.0.1:51623`
