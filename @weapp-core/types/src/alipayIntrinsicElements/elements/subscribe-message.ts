...
/**
 * @see https://opendocs.alipay.com/mini/05z9mt
 */
export type AlipayIntrinsicElementSubscribeMessage = AlipayIntrinsicElementBaseAttributes & {
  onComplete?: AlipayIntrinsicEventHandler
  'template-id'?: string
}
