 ...
 */
export type AlipayIntrinsicElementPickerView = AlipayIntrinsicElementBaseAttributes & {
  ...
  onPickEnd?: AlipayIntrinsicEventHandler
  onPickStart?: AlipayIntrinsicEventHandler
  value?: number[]
}
