...
/**
 * @see https://opendocs.alipay.com/mini/component/cover-view
 */
export type AlipayIntrinsicElementCoverView = AlipayIntrinsicElementBaseAttributes & {
  onTap?: AlipayIntrinsicEventHandler
  penetrateGuesture?: boolean
}
