 ...
 */
export type WeappIntrinsicElementPickerView = WeappIntrinsicElementBaseAttributes & {
  ...
  onPickEnd?: WeappIntrinsicEventHandler
  onPickStart?: WeappIntrinsicEventHandler
  value?: number[]
}
