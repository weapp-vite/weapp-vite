...
/**
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/basic-content/progress
 */
export type TtIntrinsicElementProgress = TtIntrinsicElementBaseAttributes & {
  active?: boolean
  'active-mode'?: string
  duration?: number
  onActiveend?: TtIntrinsicEventHandler
  percent?: number
  'stroke-width'?: number
}
