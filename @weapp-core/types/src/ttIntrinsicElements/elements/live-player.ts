...
/**
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/media-component/live-player
 */
export type TtIntrinsicElementLivePlayer = TtIntrinsicElementBaseAttributes & {
  autoplay?: boolean
  muted?: boolean
  'object-fit'?: string
  onError?: TtIntrinsicEventHandler
  onFullScreenChange?: TtIntrinsicEventHandler
  onStatechange?: TtIntrinsicEventHandler
  orientation?: string
