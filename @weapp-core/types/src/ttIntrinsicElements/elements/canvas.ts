...
/**
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/canvas/canvas
 */
export type TtIntrinsicElementCanvas = TtIntrinsicElementBaseAttributes & {
  'canvas-id'?: string
  onTouchCancel?: TtIntrinsicEventHandler
