...
/**
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/media-component/rtc-room
 */
export type TtIntrinsicElementRtcRoom = TtIntrinsicElementBaseAttributes & {
  mode?: string
