...
/**
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/list/form
 */
export type TtIntrinsicElementForm = TtIntrinsicElementBaseAttributes & {
  'clue-component-id'?: string
  'conversion-target'?: number
  onReset?: TtIntrinsicEventHandler
  onSubmit?: TtIntrinsicEventHandler
}
