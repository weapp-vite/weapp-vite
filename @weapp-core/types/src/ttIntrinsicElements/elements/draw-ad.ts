...
/**
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/open-capacity/draw-ad
 */
export type TtIntrinsicElementDrawAd = TtIntrinsicElementBaseAttributes & {
  'full-screen'?: boolean
