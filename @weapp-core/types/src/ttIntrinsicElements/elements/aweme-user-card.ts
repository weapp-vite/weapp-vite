...
/**
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/open-capacity/aweme-user-card
 */
export type TtIntrinsicElementAwemeUserCard = TtIntrinsicElementBaseAttributes & {
  'aweme-id'?: string
  fixed?: boolean
  height?: number
  'left-right-padding'?: number
