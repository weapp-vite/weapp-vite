...
/**
 * @see https://developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/component/list/checkbox-group
 */
export type TtIntrinsicElementCheckboxGroup = TtIntrinsicElementBaseAttributes & {
  name?: string
