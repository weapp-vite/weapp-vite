...
- 新增统一的 `weapp.wxml.remove` 最终模板清理入口，支持精确及通配符属性规则、标签限定属性、显式整节点删除和普通注释清理。原生模板、Vue SFC、组件与分包使用同一清理阶段，并保护平台指令、事件及框架运行时元数据；不安全的结构删除提供文件位置诊断。
  ...
  classic HMR 更新已有独立分包源码时，仅失效受影响的分包及共享入口，不再把无关主包入口全部标脏；仍由主构建校验并统一发布，保留失败后的产物和恢复重试。

  修复性能验收发现的 Vue App 附属 JSON 热更新遗漏：加载入口时将本轮解析出的 sitemap/theme 路径交给模块图，连续编辑和恢复均重新发布；配置改换路径后移除旧 JSON 依赖，避免沿用过期扫描记录。

### Patch Changes

- 补充开发态 HMR JSON profile 的构建收尾分段，区分模板规范化、最终校验、独立包等待与产物发布成本；保留端到端耗时和原有发布流程。

- Updated dependencies:
  - @weapp-vite/ast@7.4.0
  - @weapp-vite/web@1.5.7
  - wevu@7.4.0
...
- Updated dependencies:
  ...
  - @weapp-core/schematics@6.2.6
  - @weapp-core/shared@3.2.5
  - @weapp-vite/ast@7.2.0
  - @weapp-vite/eslint@0.2.7
  - @weapp-vite/i18n@0.2.6
  - @weapp-vite/mcp@1.5.6
  - @weapp-vite/miniprogram-automator@1.2.21
  - @weapp-vite/volar@2.1.10
  - @weapp-vite/web@1.5.5
  - @wevu/api@0.3.5
  - @wevu/web-apis@1.3.2
  - rolldown-require@2.0.32
  - vite-plugin-performance@2.0.5
  - weapp-ide-cli@6.1.7
  - wevu@7.2.0
...
- 修复 Tailwind 样式导入链扫描错误读取原生样式虚拟路径的问题，恢复含相对 WXSS、ACSS 和 TTSS 导入的项目构建。

- 修复连续 HMR 中 App 入口被普通编译脚本覆盖、外部 CSS 变量删除后恢复时模块图漂移，以及开发期复用失效解析上下文的问题，避免注册初始化丢失、页面白屏或后续重建中断。

- 修复开发模块图未继承文件轮询配置的问题，并缩短框架虚拟模块的输出文件名，避免深层项目目录导致构建失败。
...
- 为缺少显式配置的 React 页面生成默认 JSON 产物，保证动态与静态页面都能在微信开发者工具中注册并正常导航，同时保留已有页面及原生组件配置。
...
- 为未声明 JSON 配置的 Vue 页面生成空页面配置文件，保留已有 sidecar 配置，修复微信开发者工具拒绝导航到未注册页面的问题。
...
- Updated dependencies:
  ...
  - @weapp-vite/i18n@0.2.2
  - @weapp-vite/mcp@1.5.2
  - @weapp-vite/miniprogram-automator@1.2.17
  - @weapp-vite/web@1.5.0
  - @wevu/api@0.3.1
...
- 修复状态保持 HMR 在更新原因摘要缺失时触发运行时错误的问题。
...
- 🐛 **修复源码根目录包含构建输出目录时，stateful HMR 反复监听自身产物导致初次构建无法完成的问题；隔离独立分包与主包的 Vite 插件状态，避免 Tailwind CSS 初始产物偶发为空或归属错误；同时避免 `dev -o` 将已连接但暂时无法截图的微信开发者工具会话误判为未打开并重复启动。** [#797](https://github.com/weapp-vite/weapp-vite/pull/797) by @sonofmagic
- 📦 **Dependencies**
  → `@weapp-vite/ast@6.20.1`, `wevu@6.20.1`, `@weapp-vite/web@1.4.6`
...
- 🐛 **修复微信状态保持 HMR 连续更新 Tailwind 任意值时的重复构建与页面栈超时问题；缩短样式刷新合并窗口，并避免把未变化的小程序资产重复写入开发者工具，提升添加、修改和删除 Tailwind 类时的热更新速度与稳定性。** [#784](https://github.com/weapp-vite/weapp-vite/pull/784) by @sonofmagic
...
- 📦 Updated 8 dependencies [`b055929`](https://github.com/weapp-vite/weapp-vite/commit/b055929f8c18a2a9be800eff88f8f7806a9a4f46)
  <details><summary>Details</summary>

  `@weapp-core/constants@0.1.16`, `@wevu/web-apis@1.2.31`, `@weapp-vite/miniprogram-automator@1.2.11`, `@weapp-vite/web@1.4.2`, `wevu@6.19.2`, `weapp-ide-cli@6.0.3`, `@weapp-vite/mcp@1.4.12`, `@weapp-vite/ast@6.19.2`
...
- 📦 Updated 9 dependencies [`c7d8514`](https://github.com/weapp-vite/weapp-vite/commit/c7d85143aeb5edaaf5d1902a8bd3d5fe09ef570e)
  <details><summary>Details</summary>

  `@weapp-vite/ast@6.19.1`, `@weapp-vite/miniprogram-automator@1.2.10`, `@weapp-vite/web@1.4.1`, `@wevu/api@0.2.14`, `rolldown-require@2.0.23`, `weapp-ide-cli@6.0.2`, `wevu@6.19.1`, `@wevu/web-apis@1.2.30`, `@weapp-vite/mcp@1.4.11`
...
- 📦 **Dependencies** [`fc2bbed`](https://github.com/weapp-vite/weapp-vite/commit/fc2bbed4b642e9203d750799801ed6e43df321be)
  → `wevu@6.18.7`, `@weapp-vite/ast@6.18.7`
...
- 📦 **Dependencies** [`64b74ad`](https://github.com/weapp-vite/weapp-vite/commit/64b74ad0a04c16f7281ce789ffdc47836d1f9fef)
  → `wevu@6.18.6`, `@weapp-vite/ast@6.18.6`
...
- 📦 Updated 12 dependencies [`71e0e70`](https://github.com/weapp-vite/weapp-vite/commit/71e0e70cc7a466d67236a406d47f261ac57c815b)
  <details><summary>Details</summary>

  `@weapp-vite/ast@6.18.5`, `@weapp-vite/miniprogram-automator@1.2.8`, `@weapp-vite/web@1.3.37`, `rolldown-require@2.0.22`, `wevu@6.18.5`, `weapp-ide-cli@6.0.0`, `@weapp-core/constants@0.1.14`, `@weapp-core/shared@3.0.6`, `@wevu/web-apis@1.2.28`, `@weapp-core/init@6.0.12`, `@wevu/api@0.2.12`, `@weapp-vite/mcp@1.4.9`
...
- 📦 **Dependencies**
  → `wevu@6.18.3`, `@weapp-vite/ast@6.18.3`
...
- 📦 Updated 7 dependencies [`da04b13`](https://github.com/weapp-vite/weapp-vite/commit/da04b1334bd47f5b7182f61b17e66908aad9ca3f)
  <details><summary>Details</summary>

  `@weapp-vite/web@1.3.34`, `rolldown-require@2.0.20`, `@weapp-vite/miniprogram-automator@1.2.6`, `weapp-ide-cli@5.4.11`, `@weapp-vite/mcp@1.4.7`, `@weapp-vite/ast@6.18.0`, `wevu@6.18.0`
...
- 5ea6fe6: 修复 wevu 项目开发模式下普通 TS 文件从 `wevu` 根入口导入页面 hook 或响应式 API 时，HMR 后可能把运行时成员绑定到错误 vendor chunk 的问题。现在增量构建会稳定重写并补齐 wevu runtime 访问，避免微信开发者工具热更新后出现 `onShareAppMessage is not a function` 或 `unref is not a function`。
...
- 📦 **Dependencies**
  → `@weapp-vite/ast@6.17.7`, `wevu@6.17.7`

## 6.17.6

### Patch Changes

- ce0043a: 修复 `app.vue` 在开发热更新期间被直接写入未完成打包脚本的问题，避免入口产物残留 `@/` 等业务别名 import，导致微信开发者工具报模块未定义。

  同时修复共享依赖模块变更后 `common.js` 可能复用旧内容的问题，确保页面、布局、入口和公共依赖热更新后微信开发者工具能加载到最新产物。

- 📦 **Dependencies**
  → `@weapp-vite/ast@6.17.6`, `wevu@6.17.6`

## 6.17.5

### Patch Changes

- ba6c8c3: 修复开发模式 HMR 后 `wevu/router` 等 wevu 子入口可能残留为裸包导入的问题，避免微信开发者工具重新加载入口时出现模块未定义错误。
- 📦 **Dependencies**
  → `@weapp-vite/ast@6.17.5`, `wevu@6.17.5`

## 6.17.4

### Patch Changes

- 🐛 **修复 Vue SFC 项目在开发态修改 layout 或其他入口触发 HMR 后，`app.js` 可能保留裸 `require("wevu")`，导致微信开发者工具报 `module 'wevu.js' is not defined` 的问题。** [`c77bcec`](https://github.com/weapp-vite/weapp-vite/commit/c77bcec6162f21f3e262dfde240fc217200b18a3) by @sonofmagic
- 📦 **Dependencies**
  → `@weapp-vite/ast@6.17.4`, `wevu@6.17.4`
...
- 🐛 **修复 `wv open` 默认通过微信开发者工具 automator 临时包装项目打开的问题，并避免 `wv open` / `wv dev -o` 在官方 CLI 打开项目成功后继续通过 DevTools HTTP `/open` 二次打开项目。同时会从官方 CLI 本次输出中捕获真实服务端口，避免后续 fileutils 与 engine build 刷新误连旧端口。** [`8a75b6e`](https://github.com/weapp-vite/weapp-vite/commit/8a75b6e86990a76449e17cb02365b95ed1b4d967) by @sonofmagic
- 📦 Updated 4 dependencies [`8a75b6e`](https://github.com/weapp-vite/weapp-vite/commit/8a75b6e86990a76449e17cb02365b95ed1b4d967)
  <details><summary>Details</summary>

  `weapp-ide-cli@5.4.6`, `@wevu/web-apis@1.2.22`, `wevu@6.16.46`, `@weapp-vite/ast@6.16.46`
...
- 🐛 **优化默认 `auto` 模式下的 HMR 入口收敛逻辑。直接编辑页面或组件入口时，不再因为稳定公共 chunk 的 importer 很多而扩散成大量入口重新构建；普通旁路模板、样式、JSON 更新也不再强制 full shared chunk refresh，同时保留依赖驱动、layout、配置类和旁路拓扑变化的跨入口刷新能力。** [#681](https://github.com/weapp-vite/weapp-vite/pull/681) by @sonofmagic
- 📦 **Dependencies**
  → `@weapp-vite/ast@6.16.45`, `wevu@6.16.45`
...
- 🐛 **修复 `weapp.srcRoot` 使用非默认目录时，托管 `tsconfig.app.json` 仍固定包含 `../src/**/\*`的问题，避免小程序源码文件向上解析到错误的工作区 tsconfig 后导致`wv dev/build` 报错。** [`47ebea8`](https://github.com/weapp-vite/weapp-vite/commit/47ebea849717124ad422e98f704bb126b9542f1f) by @sonofmagic
  ...
  - 相关 CLI 提示中的建议命令统一使用 `wv prepare` 简写。
- 📦 **Dependencies**
  → `@weapp-vite/ast@6.16.42`, `wevu@6.16.42`
...
- 📦 **Dependencies**
  → `wevu@6.16.40`, `@weapp-vite/ast@6.16.40`
...
- 📦 **Dependencies**
  → `@weapp-vite/ast@6.16.39`, `wevu@6.16.39`

## 6.16.38

### Patch Changes

- 📦 Updated 5 dependencies [`90f71b0`](https://github.com/weapp-vite/weapp-vite/commit/90f71b013cd6314977d3054fedbbc043eb24dcfd)
  <details><summary>Details</summary>

  `@weapp-vite/miniprogram-automator@1.2.2`, `weapp-ide-cli@5.4.2`, `@weapp-vite/mcp@1.4.2`, `@weapp-vite/ast@6.16.38`, `wevu@6.16.38`
...
- 📦 **Dependencies** [`8f7b0e5`](https://github.com/weapp-vite/weapp-vite/commit/8f7b0e58e4105d23df2c67e75eef771ec2f48907)
  → `@weapp-vite/web@1.3.30`, `@weapp-vite/ast@6.16.37`, `wevu@6.16.37`
...
- 📦 **Dependencies** [`28f1d10`](https://github.com/weapp-vite/weapp-vite/commit/28f1d1008bdabd06ff545e9767759327650c26a7)
  → `wevu@6.16.33`, `@weapp-vite/ast@6.16.33`

## 6.16.32

### Patch Changes

- 🐛 **优化 wevu 编译产物的内部运行时导入，将响应式 API 与模板 helper 分流到更小的内部入口，避免从 `wevu` 导入 `ref`、`nextTick`、`normalizeClass` 等轻量能力时固定拉入完整组件运行时 vendor。同步发布 create-weapp-vite，保持脚手架模板依赖版本与本次修复一致。** [#641](https://github.com/weapp-vite/weapp-vite/pull/641) by @sonofmagic
- 📦 **Dependencies** [`41d4cc2`](https://github.com/weapp-vite/weapp-vite/commit/41d4cc2eeeb9c3f077d1584acb08c83c5a2868a9)
  → `wevu@6.16.32`, `@weapp-vite/ast@6.16.32`

## 6.16.31

### Patch Changes

- 🐛 **修复开发态新增自动导入 Vue SFC 组件时，组件入口可能已被标记为 loaded 导致模板产物没有重新生成的问题。** [#638](https://github.com/weapp-vite/weapp-vite/pull/638) by @sonofmagic
...
- 📦 **Dependencies** [`cc94a30`](https://github.com/weapp-vite/weapp-vite/commit/cc94a30437fa8d35be4ae796edde5ebf7d35f8ae)
  → `wevu@6.16.31`, `@weapp-vite/ast@6.16.31`

## 6.16.30

### Patch Changes

- 📦 **Dependencies** [`4a4c4fd`](https://github.com/weapp-vite/weapp-vite/commit/4a4c4fd57698feb0ac238259edcad9c7ab9ba46e)
  → `wevu@6.16.30`, `@weapp-vite/ast@6.16.30`
...
- 📦 Updated 5 dependencies [`578fed1`](https://github.com/weapp-vite/weapp-vite/commit/578fed1b2a1f140eaf6bda433405a97cce49c20d)
  <details><summary>Details</summary>

  `@weapp-core/constants@0.1.11`, `@weapp-vite/web@1.3.28`, `@wevu/web-apis@1.2.18`, `wevu@6.16.28`, `@weapp-vite/ast@6.16.28`
...
- 📦 Updated 5 dependencies [`b738d0d`](https://github.com/weapp-vite/weapp-vite/commit/b738d0d8ad2e5902f83622661a500b0c09cc2f0e)
  <details><summary>Details</summary>

  `wevu@6.16.25`, `@weapp-core/constants@0.1.10`, `@weapp-vite/web@1.3.26`, `@wevu/web-apis@1.2.17`, `@weapp-vite/ast@6.16.25`
...
- 📦 **Dependencies** [`1711744`](https://github.com/weapp-vite/weapp-vite/commit/1711744db89a574aaffef010d5380169516e34c4)
  → `wevu@6.16.24`, `@weapp-vite/ast@6.16.24`
...
- 📦 Updated 8 dependencies [`52fc0f7`](https://github.com/weapp-vite/weapp-vite/commit/52fc0f7ea021ac89ea43e58f939d99e9683e39e3)
  <details><summary>Details</summary>

  `@weapp-core/constants@0.1.9`, `wevu@6.16.21`, `@weapp-vite/miniprogram-automator@1.1.2`, `@weapp-vite/ast@6.16.21`, `@weapp-vite/web@1.3.25`, `@wevu/web-apis@1.2.16`, `weapp-ide-cli@5.3.1`, `@weapp-vite/mcp@1.3.5`
...
- 📦 Updated 5 dependencies [`362bbd3`](https://github.com/weapp-vite/weapp-vite/commit/362bbd3e3bbed438746fe4db00602204da8c7ec2)
  <details><summary>Details</summary>

  `@weapp-core/constants@0.1.8`, `@wevu/web-apis@1.2.14`, `@weapp-vite/ast@6.16.17`, `@weapp-vite/web@1.3.22`, `wevu@6.16.17`
...
- 📦 **Dependencies**
  → `@weapp-vite/ast@6.16.14`, `wevu@6.16.14`
...
- 📦 **Dependencies**
  → `wevu@6.16.12`, `@weapp-vite/ast@6.16.12`
...
- 📦 **Dependencies**
  → `wevu@6.16.10`, `@weapp-vite/ast@6.16.10`
...
- 📦 **Dependencies** [`680d7ba`](https://github.com/weapp-vite/weapp-vite/commit/680d7babdbb7b14331757db0681f8814ca93e9ec)
  → `wevu@6.16.7`, `@weapp-vite/ast@6.16.7`
...
- 📦 Updated 8 dependencies [`6703f0b`](https://github.com/weapp-vite/weapp-vite/commit/6703f0b283cf956b6f61d6eed8e3530f5c5de5eb)
  <details><summary>Details</summary>

  `wevu@6.16.6`, `@wevu/api@0.2.8`, `@wevu/web-apis@1.2.12`, `@weapp-vite/web@1.3.20`, `@weapp-vite/ast@6.16.6`, `@weapp-vite/miniprogram-automator@1.1.0`, `weapp-ide-cli@5.2.9`, `@weapp-vite/mcp@1.3.2`
...
- 🐛 **修复 request globals 安装器内联到 app 注册模块后，ESM 页面入口和 app.prelude 仍可能引用已删除 runtime chunk 的问题，并收窄 app.json 归一化范围，避免 sitemap 等旁路 JSON 被误当作 app 配置处理。** [`0dc6256`](https://github.com/weapp-vite/weapp-vite/commit/0dc6256122eba1767085cfeeaec65e96a64a06cf) by @sonofmagic
...
- 📦 **Dependencies** [`a934ef3`](https://github.com/weapp-vite/weapp-vite/commit/a934ef32641a63273fe67453e4177acda2607550)
  → `wevu@6.16.2`, `@weapp-vite/ast@6.16.2`

## 6.16.1

### Patch Changes

- 🐛 **修复 Vue SFC 组件 `<slot>` 兜底内容生成过长 `vueSlots` 数组扫描表达式的问题。编译器现在会将插槽元信息转换为对象绑定，并用 `vueSlots.<name>` 生成短条件分支，避免默认内容降级产物异常。** [#531](https://github.com/weapp-vite/weapp-vite/pull/531) by @sonofmagic
- 📦 **Dependencies**
  → `wevu@6.16.1`, `@weapp-vite/ast@6.16.1`
...
- 📦 Updated 4 dependencies [`a3451df`](https://github.com/weapp-vite/weapp-vite/commit/a3451df4f907a58d7ba1c7ebaa78bd215c017da4)
  <details><summary>Details</summary>

  `@weapp-vite/mcp@1.3.0`, `weapp-ide-cli@5.2.7`, `wevu@6.16.0`, `@weapp-vite/ast@6.16.0`
