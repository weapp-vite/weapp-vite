...
describe('defineOptions typing', () => {
  it('is declared in wevu instead of weapp-vite client.d.ts', async () => {
    ...
    const wevuPath = path.resolve(__dirname, '../../../packages-runtime/wevu/src/macros.ts')
    const wevuSharedPath = path.resolve(__dirname, '../../../packages-runtime/wevu/src/macros/shared.ts')
