...
export function registerVueTemplateToken(
  ...
  try {
    ...
    if (typeof wxmlService.setTokenDeps === 'function') {
      void wxmlService.setTokenDeps(filename, token.deps)
    }
    else if (typeof wxmlService.collectDepsFromToken === 'function' && typeof wxmlService.setDeps === 'function') {
