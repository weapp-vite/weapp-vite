...
defineAppSetup((app) => {
  app.provide('token', 1)
    ...
    expect(result.script).toContain('from "virtual:weapp-vite/runtime";')
...
const sayHello = () => 'Hello'
    ...
    expect(result.script).toContain('__wevuUnref(__wevuResolvePropValue(this, "sayHello", this.sayHello))')
    expect(result.script).toContain('__wevuResolvePropValue(this, "sayHello", this.sayHello)')
...
const getRows = () => [{ id: 'a', label: 'Alpha' }]
    ...
    expect(result.script).toContain('__wevuResolvePropValue(this, "sayHello", this.sayHello)')
    expect(result.script).toContain('__wevuResolvePropValue(this, "dasd", this.dasd)')
...
const getCase = () => '123'
    ...
    expect(result.script).toContain('__wv_bind_0')
    expect(result.script).toContain('__wevuUnref(__wevuResolvePropValue(this, "getCase", this.getCase))')
    expect(result.script).toContain('__wevuResolvePropValue(this, "getCase", this.getCase)')
  })
