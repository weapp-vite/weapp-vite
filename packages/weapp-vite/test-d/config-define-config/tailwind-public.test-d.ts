import type { CreateCompilerOptions, TailwindV4SourceOptions } from 'weapp-tailwindcss/core'
...
expectAssignable<TailwindV4SourceOptions['cssSources']>(tailwind.tailwindcss?.v4?.cssSources)
