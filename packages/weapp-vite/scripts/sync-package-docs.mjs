...
const docEntries = [
  ...
  {
    source: path.join(packagedDocsDir, 'glass-easel.md'),
    output: 'glass-easel.md',
    title: 'glass-easel Compatibility',
    summary: 'glass-easel 宿主配置、迁移诊断与无法无损自动改写的边界。',
  },
  {
...
function createIndex(entries) {
  const lines = [
    ...
    '5. 迁移 glass-easel 时读 `glass-easel.md`。',
    '6. 接入内置国际化时读 `i18n.md`。',
    '7. 接入 uni-app Vue 组件库或 Wot UI 时读 `uni-app-component-libraries.md`。',
