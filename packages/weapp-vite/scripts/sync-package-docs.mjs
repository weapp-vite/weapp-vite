...
const docEntries = [
  ...
  {
    source: path.join(packagedDocsDir, 'i18n.md'),
    output: 'i18n.md',
    title: 'First-party i18n',
    summary: '内置 locale 编译、WXS 模板翻译、运行时切换与分包实例边界。',
  },
  {
...
function createIndex(entries) {
  const lines = [
    ...
    '5. 接入内置国际化时读 `i18n.md`。',
    '6. 接入 uni-app Vue 组件库或 Wot UI 时读 `uni-app-component-libraries.md`。',
    '7. 涉及 wevu 运行时与页面/组件/store 约束时读 `wevu-authoring.md`。',
    '8. 涉及 Vue SFC 宏、模板约束与编辑器提示时读 `vue-sfc.md`、`volar.md` 与 `define-config-overloads.md`。',
    '9. 编写页面或组件单测时读 `testing.md`。',
    '10. 遇到告警、prepare、截图、日志、依赖异常时读 `troubleshooting.md`。',
    '',
    '## Included Docs',
    '',
