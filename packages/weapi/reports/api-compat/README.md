...
| `scanCode`                          | 直连 `wx.scanCode`                                  | 无同等 API，调用时按 unsupported 报错                              | 直连 `tt.scanCode`                                                |
...
| `getEnterOptionsSync`               | 直连 `wx.getEnterOptionsSync`                       | 直连 `my.getEnterOptionsSync`                                      | 无同等 API，调用时按 unsupported 报错                             |
...
| `hideHomeButton`                    | 直连 `wx.hideHomeButton`                            | 无同等 API，调用时按 unsupported 报错                              | 直连 `tt.hideHomeButton`                                          |
