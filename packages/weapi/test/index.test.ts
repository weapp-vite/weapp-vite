...
describe('weapi', () => {
  ...
  it('keeps top high-frequency alias mappings in sync', () => {
    const expectedMappings = [
      ...
      { method: 'openCard', my: 'openCard', tt: 'openCard' },
      { method: 'openChannelsActivity', my: 'openChannelsActivity', tt: 'openChannelsActivity' },
      { method: 'openChannelsEvent', my: 'openChannelsEvent', tt: 'openChannelsEvent' },
      { method: 'openChannelsLive', my: 'openChannelsLive', tt: 'openChannelsLive' },
      { method: 'openChannelsLiveNoticeInfo', my: 'openChannelsLiveNoticeInfo', tt: 'openChannelsLiveNoticeInfo' },
      { method: 'openChannelsUserProfile', my: 'openChannelsUserProfile', tt: 'openChannelsUserProfile' },
      { method: 'openChatTool', my: 'openChatTool', tt: 'openChatTool' },
      { method: 'openHKOfflinePayView', my: 'openHKOfflinePayView', tt: 'openHKOfflinePayView' },
      { method: 'openInquiriesTopic', my: 'openInquiriesTopic', tt: 'openInquiriesTopic' },
      { method: 'openOfficialAccountArticle', my: 'openOfficialAccountArticle', tt: 'openOfficialAccountArticle' },
      { method: 'openOfficialAccountChat', my: 'openOfficialAccountChat', tt: 'openOfficialAccountChat' },
      { method: 'openOfficialAccountProfile', my: 'openOfficialAccountProfile', tt: 'openOfficialAccountProfile' },
      { method: 'openPrivacyContract', my: 'openPrivacyContract', tt: 'openPrivacyContract' },
      { method: 'openSystemBluetoothSetting', my: 'openSystemBluetoothSetting', tt: 'openSystemBluetoothSetting' },
      { method: 'reportEvent', my: 'reportEvent', tt: 'reportEvent' },
      { method: 'reportMonitor', my: 'reportMonitor', tt: 'reportMonitor' },
      { method: 'reportPerformance', my: 'reportPerformance', tt: 'reportPerformance' },
      { method: 'openSingleStickerView', my: 'openSingleStickerView', tt: 'openSingleStickerView' },
      { method: 'openStickerIPView', my: 'openStickerIPView', tt: 'openStickerIPView' },
      { method: 'openStickerSetView', my: 'openStickerSetView', tt: 'openStickerSetView' },
      { method: 'openStoreCouponDetail', my: 'openStoreCouponDetail', tt: 'openStoreCouponDetail' },
      { method: 'openStoreOrderDetail', my: 'openStoreOrderDetail', tt: 'openStoreOrderDetail' },
      { method: 'pauseBackgroundAudio', my: 'pauseBackgroundAudio', tt: 'pauseBackgroundAudio' },
      { method: 'pauseVoice', my: 'pauseVoice', tt: 'pauseVoice' },
      { method: 'playBackgroundAudio', my: 'playBackgroundAudio', tt: 'playBackgroundAudio' },
      { method: 'playVoice', my: 'playVoice', tt: 'playVoice' },
      { method: 'postMessageToReferrerMiniProgram', my: 'postMessageToReferrerMiniProgram', tt: 'postMessageToReferrerMiniProgram' },
      { method: 'postMessageToReferrerPage', my: 'postMessageToReferrerPage', tt: 'postMessageToReferrerPage' },
      { method: 'preDownloadSubpackage', my: 'preDownloadSubpackage', tt: 'preDownloadSubpackage' },
      { method: 'preloadAssets', my: 'preloadAssets', tt: 'preloadAssets' },
      { method: 'preloadSkylineView', my: 'preloadSkylineView', tt: 'preloadSkylineView' },
      { method: 'preloadWebview', my: 'preloadWebview', tt: 'preloadWebview' },
      { method: 'removeSecureElementPass', my: 'removeSecureElementPass', tt: 'removeSecureElementPass' },
      { method: 'chooseInvoiceTitle', my: 'chooseInvoiceTitle', tt: 'chooseInvoiceTitle' },
      { method: 'chooseLicensePlate', my: 'chooseLicensePlate', tt: 'chooseLicensePlate' },
      { method: 'choosePoi', my: 'choosePoi', tt: 'choosePoi' },
      { method: 'closeBLEConnection', my: 'closeBLEConnection', tt: 'closeBLEConnection' },
      { method: 'createBLEConnection', my: 'createBLEConnection', tt: 'createBLEConnection' },
      { method: 'cropImage', my: 'cropImage', tt: 'cropImage' },
      { method: 'editImage', my: 'editImage', tt: 'editImage' },
      { method: 'exitVoIPChat', my: 'exitVoIPChat', tt: 'exitVoIPChat' },
      { method: 'faceDetect', my: 'faceDetect', tt: 'faceDetect' },
      { method: 'getApiCategory', my: 'getApiCategory', tt: 'getApiCategory' },
      { method: 'getBackgroundFetchToken', my: 'getBackgroundFetchToken', tt: 'getBackgroundFetchToken' },
      { method: 'getChannelsLiveInfo', my: 'getChannelsLiveInfo', tt: 'getChannelsLiveInfo' },
      { method: 'getChannelsLiveNoticeInfo', my: 'getChannelsLiveNoticeInfo', tt: 'getChannelsLiveNoticeInfo' },
      { method: 'getChannelsShareKey', my: 'getChannelsShareKey', tt: 'getChannelsShareKey' },
      { method: 'getChatToolInfo', my: 'getChatToolInfo', tt: 'getChatToolInfo' },
      { method: 'getCommonConfig', my: 'getCommonConfig', tt: 'getCommonConfig' },
      { method: 'getGroupEnterInfo', my: 'getGroupEnterInfo', tt: 'getGroupEnterInfo' },
      { method: 'getPrivacySetting', my: 'getPrivacySetting', tt: 'getPrivacySetting' },
      { method: 'initFaceDetect', my: 'initFaceDetect', tt: 'initFaceDetect' },
      { method: 'join1v1Chat', my: 'join1v1Chat', tt: 'join1v1Chat' },
      { method: 'shareAppMessageToGroup', my: 'shareAppMessageToGroup', tt: 'shareAppMessageToGroup' },
      { method: 'shareEmojiToGroup', my: 'shareEmojiToGroup', tt: 'shareEmojiToGroup' },
      { method: 'shareFileMessage', my: 'shareFileMessage', tt: 'shareFileMessage' },
      { method: 'shareFileToGroup', my: 'shareFileToGroup', tt: 'shareFileToGroup' },
      { method: 'shareImageToGroup', my: 'shareImageToGroup', tt: 'shareImageToGroup' },
      { method: 'shareToOfficialAccount', my: 'shareToOfficialAccount', tt: 'shareToOfficialAccount' },
      { method: 'shareToWeRun', my: 'shareToWeRun', tt: 'shareToWeRun' },
      { method: 'shareVideoMessage', my: 'shareVideoMessage', tt: 'shareVideoMessage' },
      { method: 'shareVideoToGroup', my: 'shareVideoToGroup', tt: 'shareVideoToGroup' },
      { method: 'showRedPackage', my: 'showRedPackage', tt: 'showRedPackage' },
      { method: 'startDeviceMotionListening', my: 'startDeviceMotionListening', tt: 'startDeviceMotionListening' },
      { method: 'startHCE', my: 'startHCE', tt: 'startHCE' },
      { method: 'startLocalServiceDiscovery', my: 'startLocalServiceDiscovery', tt: 'startLocalServiceDiscovery' },
      { method: 'startLocationUpdate', my: 'startLocationUpdate', tt: 'startLocationUpdate' },
      { method: 'startLocationUpdateBackground', my: 'startLocationUpdateBackground', tt: 'startLocationUpdateBackground' },
      { method: 'startRecord', my: 'startRecord', tt: 'startRecord' },
      { method: 'startSoterAuthentication', my: 'startSoterAuthentication', tt: 'startSoterAuthentication' },
      { method: 'stopBackgroundAudio', my: 'stopBackgroundAudio', tt: 'stopBackgroundAudio' },
      { method: 'stopDeviceMotionListening', my: 'stopDeviceMotionListening', tt: 'stopDeviceMotionListening' },
      { method: 'stopFaceDetect', my: 'stopFaceDetect', tt: 'stopFaceDetect' },
      { method: 'requestCommonPayment', my: 'requestCommonPayment', tt: 'requestCommonPayment' },
      { method: 'requestDeviceVoIP', my: 'requestDeviceVoIP', tt: 'requestDeviceVoIP' },
      { method: 'requestMerchantTransfer', my: 'requestMerchantTransfer', tt: 'requestMerchantTransfer' },
      { method: 'requirePrivacyAuthorize', my: 'requirePrivacyAuthorize', tt: 'requirePrivacyAuthorize' },
      { method: 'reserveChannelsLive', my: 'reserveChannelsLive', tt: 'reserveChannelsLive' },
      { method: 'selectGroupMembers', my: 'selectGroupMembers', tt: 'selectGroupMembers' },
      { method: 'sendHCEMessage', my: 'sendHCEMessage', tt: 'sendHCEMessage' },
      { method: 'sendSms', my: 'sendSms', tt: 'sendSms' },
      { method: 'setBackgroundFetchToken', my: 'setBackgroundFetchToken', tt: 'setBackgroundFetchToken' },
      { method: 'setEnable1v1Chat', my: 'setEnable1v1Chat', tt: 'setEnable1v1Chat' },
      { method: 'setTopBarText', my: 'setTopBarText', tt: 'setTopBarText' },
      { method: 'setWindowSize', my: 'setWindowSize', tt: 'setWindowSize' },
      { method: 'stopHCE', my: 'stopHCE', tt: 'stopHCE' },
      { method: 'stopLocalServiceDiscovery', my: 'stopLocalServiceDiscovery', tt: 'stopLocalServiceDiscovery' },
      { method: 'stopLocationUpdate', my: 'stopLocationUpdate', tt: 'stopLocationUpdate' },
      { method: 'stopRecord', my: 'stopRecord', tt: 'stopRecord' },
      { method: 'stopVoice', my: 'stopVoice', tt: 'stopVoice' },
      { method: 'subscribeVoIPVideoMembers', my: 'subscribeVoIPVideoMembers', tt: 'subscribeVoIPVideoMembers' },
      { method: 'updateVoIPChatMuteConfig', my: 'updateVoIPChatMuteConfig', tt: 'updateVoIPChatMuteConfig' },
      { method: 'updateWeChatApp', my: 'updateWeChatApp', tt: 'updateWeChatApp' },
      { method: 'getBackgroundAudioPlayerState', my: 'getBackgroundAudioPlayerState', tt: 'getBackgroundAudioPlayerState' },
      { method: 'getDeviceBenchmarkInfo', my: 'getDeviceBenchmarkInfo', tt: 'getDeviceBenchmarkInfo' },
      { method: 'getDeviceVoIPList', my: 'getDeviceVoIPList', tt: 'getDeviceVoIPList' },
      { method: 'getHCEState', my: 'getHCEState', tt: 'getHCEState' },
      { method: 'getInferenceEnvInfo', my: 'getInferenceEnvInfo', tt: 'getInferenceEnvInfo' },
      { method: 'getNFCAdapter', my: 'getNFCAdapter', tt: 'getNFCAdapter' },
      { method: 'getPerformance', my: 'getPerformance', tt: 'getPerformance' },
      { method: 'getRandomValues', my: 'getRandomValues', tt: 'getRandomValues' },
      { method: 'getRealtimeLogManager', my: 'getRealtimeLogManager', tt: 'getRealtimeLogManager' },
      { method: 'getRendererUserAgent', my: 'getRendererUserAgent', tt: 'getRendererUserAgent' },
      { method: 'getScreenRecordingState', my: 'getScreenRecordingState', tt: 'getScreenRecordingState' },
      { method: 'getSecureElementPasses', my: 'getSecureElementPasses', tt: 'getSecureElementPasses' },
      { method: 'getSelectedTextRange', my: 'getSelectedTextRange', tt: 'getSelectedTextRange' },
      { method: 'getShowSplashAdStatus', my: 'getShowSplashAdStatus', tt: 'getShowSplashAdStatus' },
      { method: 'getSkylineInfo', my: 'getSkylineInfo', tt: 'getSkylineInfo' },
      { method: 'getUserCryptoManager', my: 'getUserCryptoManager', tt: 'getUserCryptoManager' },
      { method: 'getWeRunData', my: 'getWeRunData', tt: 'getWeRunData' },
      { method: 'getXrFrameSystem', my: 'getXrFrameSystem', tt: 'getXrFrameSystem' },
      { method: 'isBluetoothDevicePaired', my: 'isBluetoothDevicePaired', tt: 'isBluetoothDevicePaired' },
      { method: 'isVKSupport', my: 'isVKSupport', tt: 'isVKSupport' },
      { method: 'createBLEPeripheralServer', my: 'createBLEPeripheralServer', tt: 'createBLEPeripheralServer' },
      { method: 'createBufferURL', my: 'createBufferURL', tt: 'createBufferURL' },
      { method: 'createCacheManager', my: 'createCacheManager', tt: 'createCacheManager' },
      { method: 'createGlobalPayment', my: 'createGlobalPayment', tt: 'createGlobalPayment' },
      { method: 'createInferenceSession', my: 'createInferenceSession', tt: 'createInferenceSession' },
      { method: 'createMediaAudioPlayer', my: 'createMediaAudioPlayer', tt: 'createMediaAudioPlayer' },
      { method: 'createMediaContainer', my: 'createMediaContainer', tt: 'createMediaContainer' },
      { method: 'createMediaRecorder', my: 'createMediaRecorder', tt: 'createMediaRecorder' },
      { method: 'createTCPSocket', my: 'createTCPSocket', tt: 'createTCPSocket' },
      { method: 'createUDPSocket', my: 'createUDPSocket', tt: 'createUDPSocket' },
      { method: 'createVideoDecoder', my: 'createVideoDecoder', tt: 'createVideoDecoder' },
      { method: 'loadBuiltInFontFace', my: 'loadBuiltInFontFace', tt: 'loadBuiltInFontFace' },
      { method: 'notifyGroupMembers', my: 'notifyGroupMembers', tt: 'notifyGroupMembers' },
      { method: 'requestIdleCallback', my: 'requestIdleCallback', tt: 'requestIdleCallback' },
      { method: 'revokeBufferURL', my: 'revokeBufferURL', tt: 'revokeBufferURL' },
      { method: 'rewriteRoute', my: 'rewriteRoute', tt: 'rewriteRoute' },
      { method: 'seekBackgroundAudio', my: 'seekBackgroundAudio', tt: 'seekBackgroundAudio' },
      { method: 'setEnableDebug', my: 'setEnableDebug', tt: 'setEnableDebug' },
      { method: 'setInnerAudioOption', my: 'setInnerAudioOption', tt: 'setInnerAudioOption' },
      ...
      { method: 'onBeforeAppRoute', my: 'onAppShow', tt: 'onAppShow' },
      { method: 'onBeforePageLoad', my: 'onAppShow', tt: 'onAppShow' },
      { method: 'onBeforePageUnload', my: 'onAppShow', tt: 'onAppShow' },
      { method: 'onBLEConnectionStateChange', my: 'onAppShow', tt: 'onAppShow' },
      { method: 'onBLEMTUChange', my: 'onAppShow', tt: 'onAppShow' },
      { method: 'onBLEPeripheralConnectionStateChanged', my: 'onAppShow', tt: 'onAppShow' },
      { method: 'onCopyUrl', my: 'onAppShow', tt: 'onAppShow' },
      { method: 'onEmbeddedMiniProgramHeightChange', my: 'onAppShow', tt: 'onAppShow' },
      { method: 'onGeneratePoster', my: 'onAppShow', tt: 'onAppShow' },
      { method: 'onHCEMessage', my: 'onAppShow', tt: 'onAppShow' },
      { method: 'offBLEMTUChange', my: 'offAppShow', tt: 'offAppShow' },
      { method: 'offBLEPeripheralConnectionStateChanged', my: 'offAppShow', tt: 'offAppShow' },
      { method: 'offCopyUrl', my: 'offAppShow', tt: 'offAppShow' },
      { method: 'offEmbeddedMiniProgramHeightChange', my: 'offAppShow', tt: 'offAppShow' },
      { method: 'offGeneratePoster', my: 'offAppShow', tt: 'offAppShow' },
      { method: 'offHCEMessage', my: 'offAppShow', tt: 'offAppShow' },
      { method: 'offKeyboardHeightChange', my: 'offAppShow', tt: 'offAppShow' },
      { method: 'offKeyDown', my: 'offAppShow', tt: 'offAppShow' },
      { method: 'offKeyUp', my: 'offAppShow', tt: 'offAppShow' },
      { method: 'offLocalServiceDiscoveryStop', my: 'offAppShow', tt: 'offAppShow' },
    ] as const
